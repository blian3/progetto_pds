...
namespace MouseKeyboardLibrary
{
    ...
    {
        //private static ClipboardContent cbContent;
        //private byte[] cbContent;
        ...
        public static byte[] getClipboard()
        {
            ...
            Thread thread = new Thread(() =>
            {
                ...
                {
                    cbContent = new ClipboardContent(ClipboardContentType.FILEDROPLIST, ObjectToByteArray(Clipboard.GetFileDropList()));
            ...
            Thread thread = new Thread(() =>
            {
                switch (cc.Type)
                {
                    ...
                    case ClipboardContentType.FILEDROPLIST:
                        Clipboard.SetFileDropList((StringCollection)ByteArrayToObject(cc.Content));
                        return;
                }
            });
            thread.SetApartmentState(ApartmentState.STA);
